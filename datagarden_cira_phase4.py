...
APP_TITLE = "Data Garden - CIRA Phase 4"
CANVAS_BG = "#111215"
GRID_COLOR = "#22252a"
...
def restore_snapshot(snapshot):
    ...
    try:
        if "selection" in snapshot["workspace"]:
            selection_set(
                snapshot["workspace"]["selection"]["ids"],
                snapshot["workspace"]["selection"]["primary"],
            )
        else:
            selection_single(snapshot["workspace"].get("selected"))
